...
//   BalloongameModel.findOne({ username: username.toLowerCase() }).then((user) => {
//     if (user) {
...
//   BalloongameModel.create({ username: username.toLowerCase(), password })
...
//       { $inc: { score: 10 } }, // Increment the score if the user exists
